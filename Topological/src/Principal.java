...
public class Principal extends Application{
    ...
    public void start(Stage primaryStage) {
        ...
        escenario.setTitle("Topological sort");
    ...
    public void lee(File archivo){
        ...
        try{
            ...
            grafica = new Grafica(true, orden); //Se crea la gráfica
    ...
    public void setStyle(){
        ...
        +"edge.punteado {stroke-mode: dashes;}"
    ...
    public void dibujaGrafica(){
        ...
        for(Vertice v : grafica.vertices){
            ...
            nodoV.setAttribute("ui.label", v.toString()+", "+v.tsi);
        }
    ...
    public void actualizaGrafica(){
        ...
        for(Integer[] par : actual.estVert){
            Node nodoGS = graphStream.getNode(par[0].toString());
            if(par[1] == 0){
                nodoGS.setAttribute("ui.class", "negro");
            }else{
                nodoGS.setAttribute("ui.class", "visitado");
            }
            nodoGS.setAttribute("ui.label", "v"+par[0]+", "+par[1]);
        }

        //Aristas punteadas
        for(Integer[] ari : actual.punteadas){
            Edge edgeGS = graphStream.getEdge(ari[0]+","+ari[1]);
            if(edgeGS != null){
                edgeGS.setAttribute("ui.class", "punteado");
            }
        }
    ...
    public void inicia(){
        ...
        exec = new Ejecucion();
        Algoritmo.topologicalSort(grafica, exec);
        itAct = 0;
        actualizaGrafica();
    }
