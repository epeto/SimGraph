...
public class Grafica {
    ...
    */
    ...
    /**
     * Genera la gráfica transpuesta de ésta.
     */
    public Grafica transpuesta(){
        Grafica trans = new Grafica(dirigida, getOrden());
        //Por cada arco (u,v) en esta gráfica se agrega (v,u) en la transpuesta.
        for(Vertice u : vertices){
            for(Vertice v : u.ady){
                trans.agregaArista(v.id,u.id);
            }
        }
        return trans;
    }
